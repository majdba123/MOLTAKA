    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="{{ url('assets/images/auth/bg-gradient.png') }}" alt="image"
            ...
            <div
                ...
                <img src="{{ url('assets/images/auth/coming-soon-object1.png') }}" alt="image"
                    class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                <img src="{{ url('assets/images/auth/coming-soon-object2.png') }}" alt="image"
                    class="absolute left-24 top-0 h-40 md:left-[30%]" />
                <img src="{{ url('assets/images/auth/coming-soon-object3.png') }}" alt="image"
                    class="absolute right-0 top-0 h-[300px]" />
                <img src="{{ url('assets/images/auth/polygon-object.svg') }}" alt="image"
