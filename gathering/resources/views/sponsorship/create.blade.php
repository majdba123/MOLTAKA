...
@section('content')
    ...
    <div class="container" style="width: 50%;">
        ...
        <!-- form controls -->
        <form class="space-y-5" method="POST" action="{{ route('sponsorship.store') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div>
                ...
                <input type="url" name="link" placeholder="Some url..." class="form-input" required />
            </div>
            <hr>
