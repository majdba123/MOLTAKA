...
@section('content')
    ...
    <div class="container" style="width: 50%;">
        ...
        <div
            ...
            <div class="py-7 px-6">
                ...
                <div>
                    ...
                    <input type="text" name="name"  value="{{ $card->name }}"  placeholder="Some one..." class="form-input" disabled />
                </div>
                <hr>
                ...
                <div>
                    ...
                    <input type="url" name="link"  value="{{ $card->link }}"  placeholder="Some url..." class="form-input" disabled />
                </div>
                <hr>
        ...
        <!-- form controls -->
        <form class="space-y-5" method="POST" action="{{ route('sponsorship.update', $card) }}"
            ...
            <div>
                <label for="ctnEmail">name</label>
                <input type="text" name="name" value="{{ $card->name }}" placeholder="Some one..."
            ...
            <div>
                <label for="ctnEmail">link</label>
                <input type="url" name="link" value="{{ $card->link }}" placeholder="Some url..."
                    class="form-input" required />
            </div>
            <hr>
