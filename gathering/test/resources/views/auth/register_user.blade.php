...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url('resources/views/main/assets/favicon.png') }}" />
...
@section('content')
    <div class="mx-auto w-full max-w-[440px]">
        ...
        <form class="space-y-5 dark:text-white" method="POST" action="{{ route('store_user') }}">
            @csrf
            <div>
                <label for="Name">Name</label>
                <div class="relative text-white-dark">
