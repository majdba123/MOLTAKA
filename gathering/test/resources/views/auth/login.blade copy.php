...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ url('resources/views/home/assets/favicon.png') }}" />
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <link rel="stylesheet" type="text/css" media="screen"
        href="{{ url('resources/views/home/assets/css/style.css') }}" />
</head>
...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="{{ url('resources/views/home/assets/images/auth/bg-gradient.png') }}" alt="image"
            ...
            <div
                ...
                <img src="{{ url('resources/views/home/assets/images/auth/coming-soon-object1.png') }}" alt="image"
                    class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                <img src="{{ url('resources/views/home/assets/images/auth/coming-soon-object2.png') }}" alt="image"
                    class="absolute left-24 top-0 h-40 md:left-[30%]" />
                <img src="{{ url('resources/views/home/assets/images/auth/coming-soon-object3.png') }}" alt="image"
                    class="absolute right-0 top-0 h-[300px]" />
                <img src="{{ url('resources/views/home/assets/images/auth/polygon-object.svg') }}" alt="image"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'"  method="POST" action="{{ route('login') }}">
                                <div>
                                    <label for="Email">Email</label>
                                    <div class="relative text-white-dark">
                                        <input id="Email" type="email" placeholder="Enter Email" name="email"  required autocomplete="current-password"  class="form-input ps-10 placeholder:text-white-dark" />
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input id="Password" type="password" placeholder="Enter Password" name="password" required autocomplete="current-password" class="form-input ps-10 placeholder:text-white-dark" />
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path opacity="0.5"
    ...
    <script src="{{ url('resources/views/home/assets/js/alpine-collaspe.min.js') }}"></script>
    <script src="{{ url('resources/views/home/assets/js/alpine-persist.min.js') }}"></script>
    <script defer src="{{ url('resources/views/home/assets/js/alpine-ui.min.js') }}"></script>
    <script defer src="{{ url('resources/views/home/assets/js/alpine-focus.min.js') }}"></script>
    <script defer src="{{ url('resources/views/home/assets/js/alpine.min.js') }}"></script>

    <script src="{{ url('resources/views/home/assets/js/custom.js') }}"></script>
