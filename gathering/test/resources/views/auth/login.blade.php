...
@section('content')
    <div class="mx-auto w-full max-w-[440px]">
        ...
        <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'" method="POST"
            action="{{ route('login') }}">
            <div>
                <label for="Email">Email</label>
                <div class="relative text-white-dark">
                    <input id="Email" type="email" placeholder="Enter Email" name="email" required
                        autocomplete="current-password" class="form-input ps-10 placeholder:text-white-dark" />
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0">
                <img src="{{ url('resources/views/main/assets/images/auth/bg-gradient.png') }}" alt="image"
            ...
            <div
                ...
                <img src="{{ url('resources/views/main/assets/images/auth/coming-soon-object1.png') }}" alt="image"
                    class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                <img src="{{ url('resources/views/main/assets/images/auth/coming-soon-object2.png') }}" alt="image"
                    class="absolute left-24 top-0 h-40 md:left-[30%]" />
                <img src="{{ url('resources/views/main/assets/images/auth/coming-soon-object3.png') }}" alt="image"
                    class="absolute right-0 top-0 h-[300px]" />
                <img src="{{ url('resources/views/main/assets/images/auth/polygon-object.svg') }}" alt="image"
