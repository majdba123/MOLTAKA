...
@section('content')
    ...
    <div class="card">
        ...
        @foreach ($supervisor_speechs as $item)
            <!-- card -->
            <div style="display: flex; flex-direction: column;"
                ...
                <div style="    display: flex;     justify-content: space-evenly;"
                    ...
                    <!-- زر التعديل -->
                    <a href="{{ route('supervisor_speech.edit', $item->id) }}"
                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-600">
                        <i class="fa-regular fa-pen-to-square"></i>
                    </a>


                    <form id="delete-form-{{ $item->id }}" action="{{ route('supervisor_speech.destroy', $item->id) }}"
