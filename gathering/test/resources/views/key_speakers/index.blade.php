        ...
        @foreach ($Key_speakerss as $item)
            ...
            <div style="display: flex; flex-direction: column;"
                ...
                <div style="    display: flex;     justify-content: space-evenly;"
                    ...
                    <!-- زر التعديل -->
                    <a href="{{ route('key_speakers.edit', $item->id) }}"
                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-600">
                        <i class="fa-regular fa-pen-to-square"></i>
                    </a>


                    <form id="delete-form-{{ $item->id }}" action="{{ route('key_speakers.destroy', $item->id) }}"
                ...
                <div class="py-7 px-6">
                    ...
                    <!-- زر تحميل الملف -->
                    @if (!empty($item->file))
                        <a href="{{ asset($item->file) }}" class="mt-4 inline-block text-center" download>
