...
@section('content')
    ...
    <div class="container" style="width: 50%;">
        ...
        <!-- form controls -->
        <form class="space-y-5" method="POST" action="{{ route('goals.update', $card) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input id="ctnFile" type="file" name="image" class="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-primary" />
            </div>
